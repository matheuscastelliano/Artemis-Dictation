...
_TRANSLATIONS["en"] = {
    ...
    "tray.toggle.start": "Start recording ({name})",
    ...
    "cfg.capture.hint": "Hold every key, then release them all to confirm.",
    # -- dialogos
...
_TRANSLATIONS["pt"] = {
    ...
    "tray.toggle.start": "Iniciar gravacao ({name})",
    "tray.toggle.stop": "Parar gravacao",
    ...
    "cfg.capture.hint": "Segure todas as teclas e solte-as para confirmar.",
...
_TRANSLATIONS["es"] = {
    ...
    "tray.toggle.start": "Iniciar grabacion ({name})",
    "tray.toggle.stop": "Detener grabacion",
    ...
    "cfg.capture.escape": "Esc cancela.",
    "cfg.capture.hint": "Mantén pulsadas todas las teclas y suéltalas para confirmar.",
